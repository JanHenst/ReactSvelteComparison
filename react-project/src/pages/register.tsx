...
export const Register: FC = () => {
    ...
    return (
        <form className="max-w-sm w-full mx-auto" onSubmit={handleSubmit}>
            ...
            <div className="mb-5">
                <label htmlFor="repeatPassword" className={error ? errorTextClasses : normalTextClasses}>
            ...
            <button type="submit"
                    className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center">Register
            </button>
        </form>
);
};